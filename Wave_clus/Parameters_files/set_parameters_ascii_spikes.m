...
par.sr= 25000;                         % sampling rate  changed to 25kHz   
par.w_pre = 20;                          % number of pre-event data points stored default 29
par.w_post = 30;                         % number of post-event data points stored default 61
...
%par.detection = 'neg';               % default was 'neg' now pos
par.detection = 'pos';
% 
