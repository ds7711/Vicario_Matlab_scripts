...
% if exist([fname '.dg_01.lab'], 'file')    % If fails to load the file or the file doesn't exist, don't load to contnue processing other files
    ...
    delete(fname_in); 
% else
%     clu = 0;  % If fails to load the file or the file doesn't exist, clu = 0 to signify skip this file
%     tree = 0; 
end
